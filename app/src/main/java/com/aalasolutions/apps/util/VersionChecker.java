package  com.aalasolutions.apps.util;
...
import com.aalasolutions.apps.util.VersionChecker.VersionInfo;
...
public class VersionChecker extends AsyncTask<String, Void, VersionInfo> {
	...
	private static final String PREF_FILE_NAME = "com.aalasolutions.apps.version";
	private static final String PREF_KEY_DEPRECATED_VERSION = "com.aalasolutions.apps.util.version.deprecated_version";
	private static final String PREF_KEY_AVAILABLE_VERSION = "com.aalasolutions.apps.util.version.current_version";
	private static final String PREF_KEY_LAST_CHECK = "com.aalasolutions.apps.util.version.last_check";
...
//			mPrefsCurrentVersion = vi.current;
	...
	private static boolean check(VersionInfo vi, String checkSum) {
		try {
			...
			// The VersionInfo
			byte[] viInputBytes = ("com.aalasolutions.apps.locker " + vi.current + " " + vi.deprecated)
					.getBytes("UTF-8");

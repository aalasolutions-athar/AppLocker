...
class RateManager {
	...
	private static final String PREF_KEY_COUNT = "com.aalasolutions.apps.androidlib.rate.count";
	/**
	 * After how many times should the share dialog be shown for the first time?
	 */
	private static final String PREF_KEY_OFFSET = "com.aalasolutions.apps.androidlib.rate.offset";
	/** After the first time, each how many times should the dialog show? */
	private static final String PREF_KEY_REPEAT = "com.aalasolutions.apps.androidlib.rate.repeat";
	private static final int OFFSET_DEFAULT = 7;
	private static final int REPEAT_DEFAULT = 5;

	private static final String PREF_KEY_NEVER = "com.aalasolutions.apps.androidlib.rate.never";

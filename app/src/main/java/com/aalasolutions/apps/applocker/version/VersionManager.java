...
public class VersionManager {
    ...
    private static final String PREFS_FILENAME = "com.aalasolutions.apps.update";

    private static final String PREFS_VERSION_MATCHED = "com.aalasolutions.apps.update.version";
    /**
     * This version is OR WILL BE deprecated
     */
    private static final String PREFS_DEPRECATED = "com.aalasolutions.apps.update.deprecated";
    /**
     * This version's deprecation time
     */
    private static final String PREFS_DEPRECATION_TIME = "com.aalasolutions.apps.update.deprecation_time";
    /**
     * If server time >= warning time, the user should get warned
     */
    private static final String PREFS_WARN_TIME = "com.aalasolutions.apps.update.warn_before_time";
    /**
     * Current server time
     */
    private static final String PREFS_SERVER_TIME = "com.aalasolutions.apps.update.server_time";
    /**
     * Custom prefix to be added to user-defined objects
     */
    private static final String PREFS_VALUES_PREFIX = "com.aalasolutions.apps.update.values.custom.";

    // Prefs in persistent file will not be wiped when a new version is applied
    // from server
    private static final String PERSISTENT_FILENAME = "com.aalasolutions.apps.update.pers";
    /**
     * The url to query for version info
     */
    private static final String PREFS_URL = "com.aalasolutions.apps.update.url";

    /**
     * This indicates the old version for #isJustUpdated()
     */
    private static final String PREFS_OLD_VERSION = "com.aalasolutions.apps.update.values.old_version";

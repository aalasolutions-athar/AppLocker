...
import com.aalasolutions.apps.ads.AdMobInterstitialHelper;
import com.aalasolutions.apps.applocker.Constants;
import com.aalasolutions.apps.applocker.LockerAdInterface;
import com.aalasolutions.apps.applocker.LockerAnalytics;
import com.aalasolutions.apps.applocker.R;
import com.aalasolutions.apps.applocker.ui.MainActivity;
import com.aalasolutions.apps.applocker.util.PrefUtils;
import com.aalasolutions.apps.applocker.version.VersionManager;
import com.aalasolutions.apps.applocker.version.VersionUtils;
...
public class AppLockService extends Service {
     ...
     * and is running
     */
    public static final String BROADCAST_SERVICE_STARTED = "com.aalasolutions.apps.applocker.intent.action.service_started";
    /**
     * Sent to {@link MainActivity} when the service has been stopped
     */
    public static final String BROADCAST_SERVICE_STOPPED = "com.aalasolutions.apps.applocker.intent.action.service_stopped";
    /**
     ...
     */
    public static final String CATEGORY_STATE_EVENTS = "com.aalasolutions.apps.applocker.intent.category.service_start_stop_event";
     ...
     */
    private static final String ACTION_STOP = "com.aalasolutions.apps.applocker.intent.action.stop_lock_service";
    /**
     * Starts the alarm
     */
    private static final String ACTION_START = "com.aalasolutions.apps.applocker.intent.action.start_lock_service";
    /**
     ...
     */
    private static final String ACTION_RESTART = "com.aalasolutions.apps.applocker.intent.action.restart_lock_service";

    private static final String EXTRA_FORCE_RESTART = "com.aalasolutions.apps.applocker.intent.extra.force_restart";
    ...
    private void showLocker(String packageName) {
        Intent dialogIntent = new Intent(getBaseContext(), ErrorDialog.class);
        dialogIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        dialogIntent.putExtra("package",packageName);
